export default function ButtonBlack(props) {
  ...
  return (
    <button
      ...
      className="play text-white rounded-lg bg-black hover:bg-gray-100 hover:text-black focus:outline-none font-medium text-lg px-5 py-2.5 text-center mr-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 "
    >
      {props.label}
    </button>
  );
